...
public class MessageActionsTest {
    ...
    @Test
    public void testGetWeightedRandomMessageToPublic_WithN_is100_ShouldThrowException() throws IllegalArgumentException{
        ArrayList randomList = new ArrayList();
        for (int i = 0; i < 100; i++) {
            Radomizer radomizer = new Radomizer();
            randomList.add(radomizer.randomIntInRange(1, 100));
    ...
    @Test
    public void testGetWeightedRandomMessageToPublic_WithN_is1_ShouldThrowException() throws IllegalArgumentException{
    ...
    @Test
    public void testGetWeightedRandomMessageToPublic_WeightIs10Pow9_ShouldBePassed() throws IllegalArgumentException{
        int tenPow9 = (int)Math.pow(10, 9);
    ...
    @Test()
    public void testGetWeightedRandomMessageToPublic_WeightIs0_ShouldBePassed() throws IllegalArgumentException{
        int weightArray[] = {0};
        MessageActions messageActions = new MessageActions();
